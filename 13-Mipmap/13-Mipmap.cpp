...
osg::Image* createCustomMipmap(unsigned int resolution)
{
	...
	image->setImage(resolution, resolution, 1, GL_RGBA, GL_RGBA,
		GL_UNSIGNED_BYTE, new unsigned char[totalSize], osg::Image::USE_NEW_DELETE);
...
int main()
{
	...
	quad1->addDrawable(osg::createTexturedQuadGeometry(
		osg::Vec3(0, 0, 0), osg::Vec3(1, 0, 0), osg::Vec3(0, 0, 1)));
	...
	quad2->addDrawable(osg::createTexturedQuadGeometry(
		osg::Vec3(2, 0, 0), osg::Vec3(1, 0, 0), osg::Vec3(0, 0, 1)));
